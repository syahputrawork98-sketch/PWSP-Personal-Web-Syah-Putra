...
| F03 | Project Portfolio System | frontend/backend | Completed | Rangkaian sistem proyek multibahasa (F03M-F03Q) selesai penuh dengan tab editor EN/ID/JA, validasi data, switcher navbar, dan API fallback. | F03R — Multilingual CMS Expansion Planning atau F04M / F05 | [F03_PROJECT_PORTFOLIO_SYSTEM.md](features/F03_PROJECT_PORTFOLIO_SYSTEM.md) |
